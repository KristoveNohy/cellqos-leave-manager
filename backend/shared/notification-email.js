...
function buildLeaveRequestDetails(payload) {
...
export function buildNotificationEmail(type, payload) {
    ...
    switch (type) {
        ...
        case "PASSWORD_RESET":
            return {
                ...
                text: `Reset vykonal ${safePayload.adminName ?? "admin"}${safePayload.adminEmail ? ` (${safePayload.adminEmail})` : ""}.`,
            };
        default:
            return {
                subject: "Notifikácia",
